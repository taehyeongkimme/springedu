...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-4">
			<form:form class="form-findId" modelAttribute="findID" action="${pageContext.request.contextPath}/login/findId">
				...
				<div class="form-label-group mb-3">
					<label>찾은 아이디</label> <input type="text" class="form-control" readonly="true" value="${mdto.id }"></input>
				</div>
				
				<div class="form-label-group mb-3 row">
					 <div class="col-md" >
						<button class="btn btn-md btn-primary btn-block" type="submit" id="findId">조회</button>
					 </div>
					 <div class="col-md" >
